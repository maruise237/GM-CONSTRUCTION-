export const siteConfig = {
  ...
  ceo: "Ngaelle Dorivice Nkanpa Moffo",
  ceoTitle: "Ingénieur en Génie Civil (Option Structure)",
  tagline: "Construisons ensemble votre futur",
  description:
    "GM CONSTRUCTION est une entreprise créée par une ingénieure en génie civil, acteur de référence dans les domaines du BTP, des études et de la promotion immobilière.",
  email: "nmndorivice@gmail.com",
  phone: "+221 78 662 06 20",
  address: "Ngor Almadies, Sénégal",
  website: "www.gmconstruction.com",
  linkedin: "https://www.linkedin.com/in/ngaelle-dorivice-nkanpa-moffo-86b4a7177/",
  year: 2026,
  intro:
...
export const socialLinks = [
  { name: "Facebook", url: "#" },
  { name: "Twitter", url: "#" },
  { name: "LinkedIn", url: "https://www.linkedin.com/in/ngaelle-dorivice-nkanpa-moffo-86b4a7177/" },
  { name: "YouTube", url: "#" },
]
